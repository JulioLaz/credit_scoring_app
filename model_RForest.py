...
def reloj_default(prediccion_binaria,porcentaje_acierto_default):
    ...
    if prediccion_binaria[0] == 1:
      ...
      #   ax.annotate(f'{success}%', xy=(-1.5,.7),fontsize=20,color='darkorange',fontweight='bold')
        ax.annotate('Cliente NO apto',xy=(-.45, 1.2),color='darkorange', fontsize=28,fontweight='bold')
        if success>0 and success<30:
          ax.annotate("", xy=(0, 0), xytext=(-.15, .6), arrowprops=dict(arrowstyle='<-', linewidth=5, color='gold'))
        elif success>=30 and success<51:
          ax.annotate("", xy=(0, 0), xytext=(-.3, .5), arrowprops=dict(arrowstyle='<-', linewidth=5, color='gold'))
        elif success>=51 and success<65:
          ax.annotate("", xy=(0, 0), xytext=(-.5, .4), arrowprops=dict(arrowstyle='<-', linewidth=5, color='orange'))
        elif success>=65 and success<75:
          ax.annotate("", xy=(0, 0), xytext=(-.6, .2), arrowprops=dict(arrowstyle='<-', linewidth=5, color='orange'))
        elif success<100:
          ax.annotate("", xy=(0, 0), xytext=(-.6, 0.05), arrowprops=dict(arrowstyle='<-', linewidth=5, color='orange'))
    else:
      ...
      #   ax.annotate(f'{success}%', xy=(1,.7),fontsize=20,color='forestgreen',fontweight='bold')
        if success>0 and success<30:
          ax.annotate("", xy=(0, 0), xytext=(.15, .6), arrowprops=dict(arrowstyle='<-', linewidth=5, color='limegreen'))
        elif success>=30 and success<51:
          ax.annotate("", xy=(0, 0), xytext=(.3, .5), arrowprops=dict(arrowstyle='<-', linewidth=5, color='limegreen'))
        elif success>=51 and success<65:
          ax.annotate("", xy=(0, 0), xytext=(.48, .38), arrowprops=dict(arrowstyle='<-', linewidth=5, color='forestgreen'))
        elif success>=65 and success<75:
          ax.annotate("", xy=(0, 0), xytext=(.6, .2), arrowprops=dict(arrowstyle='<-', linewidth=5, color='green'))
        elif success<100:
          ax.annotate("", xy=(0, 0), xytext=(.6, 0.05), arrowprops=dict(arrowstyle='<-', linewidth=5, color='green'))
